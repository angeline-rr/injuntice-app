...
import '../../../../domain/models/character_entity.dart'; // Ajuste conforme seu projeto
...
class _CharacterFormViewState extends State<CharacterFormView> {
  ...
  void initState() {
    ...
    // Iniciando com os valores médios da factory se for novo
        ...
        child: ListView(
          ...
          children: [
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    onEditingComplete: () {
                      ...
                      _healthController.text = val.clamp(100, 5000).toString();
                      FocusScope.of(context).unfocus(); // Fecha o teclado
                    },
                  ),
                ),
            ...
            ElevatedButton(
              ...
              child: Text(widget.characterToEdit == null ? 'CRIAR' : 'SALVAR ALTERAÇÕES'),
            ),
          ],
        ),
      ),
